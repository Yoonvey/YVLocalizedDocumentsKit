 ...
 */
typedef enum {
    CLMDAlertActionStyleDefault = 0,
    CLMDAlertActionStyleCancel,
    CLMDAlertActionStyleDestructive
}CLMDAlertActionStyle;





@interface CLMDAlertTools : NSObject


//@property (nonatomic, assign) BOOL isAlertShowNow;
 ...
 ***注意***
 UIAlertActionStyleCancel/CLMDAlertActionStyleCancel最多只能有一个，否则崩溃
 Log:
